...
public class ShowKQXSMT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowKQXSMT.this, Home.class);
    ...
    private void loadRssAG() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document rssDocument = Jsoup.connect("https://kqxs.net.vn/rss-feed/mien-trung-xsmt.rss").get();
