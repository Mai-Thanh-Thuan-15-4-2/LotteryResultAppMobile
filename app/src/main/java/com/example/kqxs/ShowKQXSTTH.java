...
public class ShowKQXSTTH extends AppCompatActivity {

    private ArrayList<KQXSModel> rssItems;
    private RecyclerView recyclerView;
    private KQXSTTHAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new KQXSTTHAdapter(rssItems);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowKQXSTTH.this, ListXSTheoDai.class);
    ...
    private void loadRss() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document rssDocument = Jsoup.connect("https://kqxs.net.vn/rss-feed/xo-so-thua-thien-hue-xstth.rss").get();
