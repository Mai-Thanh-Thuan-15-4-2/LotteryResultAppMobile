...
public class ShowKQXSVT extends AppCompatActivity {

    private ArrayList<KQXSModel> rssItems;
    private RecyclerView recyclerView;
    private KQXSVTAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new KQXSVTAdapter(rssItems);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowKQXSVT.this, ListXSTheoDai.class);
    ...
    private void loadRss() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document rssDocument = Jsoup.connect("https://kqxs.net.vn/rss-feed/xo-so-vung-tau-xsvt.rss").get();
