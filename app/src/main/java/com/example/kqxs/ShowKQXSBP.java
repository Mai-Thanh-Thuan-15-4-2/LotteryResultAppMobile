...
public class ShowKQXSBP extends AppCompatActivity {

    private ArrayList<KQXSModel> rssItems;
    private RecyclerView recyclerView;
    private KQXSBPAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new KQXSBPAdapter(rssItems);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowKQXSBP.this, ListXSTheoDai.class);
    ...
    private void loadRss() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document rssDocument = Jsoup.connect("https://kqxs.net.vn/rss-feed/xo-so-binh-phuoc-xsbp.rss").get();
