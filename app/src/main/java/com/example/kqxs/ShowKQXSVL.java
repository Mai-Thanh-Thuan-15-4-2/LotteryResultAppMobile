...
public class ShowKQXSVL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowKQXSVL.this, ListXSTheoDai.class);
    ...
    private void loadRss() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document rssDocument = Jsoup.connect("https://kqxs.net.vn/rss-feed/xo-so-vinh-long-xsvl.rss").get();
